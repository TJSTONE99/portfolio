...
const CreateBlogPost: NextPage = (props) => {
  const [showLoginDialog, setShowLoginDialog] = React.useState(true);
  ...
  return (
    <div>
      ...
      {showLoginDialog ? (
        <>
          <Dialog setShowModal={setShowLoginDialog} title="Login" bodyComponent={<RegisterForm />}/>
        </>
      ) : null}
    </div>
  );
